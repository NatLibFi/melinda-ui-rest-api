...
export const organizations = [
  ...
  // {
  //   value: "Kemi-Tornion ammattikorkeakoulu - 2505", <-- Lapin amk
  //   text: ""
  // },
  // {
  //   value: "Mikkelin ammattikorkeakoulu - 2506", <-- Kaakkois-Suomen amk
  //   text: ""
  // },
  {
  ...
  // {
  //   value: "Rovaniemen ammattikorkeakoulu - 2538", <-- Lapin amk
  //   text: ""
  // },
  {
  ...
  // {
  //   value: "Kymenlaakson ammattikorkeakoulu - 2608", <-- Xamk
  //   text: ""
  // },
  {
  ...
  // },
  {
    value: "Helsingin seudun yliopistollinen keskussairaala (HYKS)", // <--- kts yliopistolliset keskussairaalat
    text: ""
  },
  {
