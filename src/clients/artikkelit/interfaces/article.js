...
export function refreshSciencesList() {
  ...
  idbGetStoredValues('artoSciences').then(sciences => {
    sciences.forEach(scienceData => {
      ...
      const removeButton = createIconButton('delete_outline', ['alternate-red', 'button-small'], `return removeScience(event, ${scienceData.key})`, 'Poista');
...
export function refreshMetodologysList() {
  ...
  idbGetStoredValues('artoMetodologys').then(metodologys => {
    metodologys.forEach(metodologyData => {
      ...
      const div = document.createElement('div');
      div.classList.add('full-width');
      const removeButton = createIconButton('delete_outline', ['alternate-red', 'button-small'], `return removeMetodology(event, ${metodologyData.key})`, 'Poista');
...
export function addArticleLink(event) {
  ...
  const removeButton = createIconButton('delete_outline', ['alternate-red', 'button-small'], `return removeArticleLink(event)`, 'Poista');
