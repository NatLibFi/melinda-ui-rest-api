import {startProcess, stopProcess, showNotificationBanner, highlightElement} from '/common/ui-utils.js';
...
function updateCorrelationIdListModal() {
  ...
  idbGetList('correlationIdList')
    ...
    .catch((error) => {
      ...
      showNotificationBanner({style: 'info', text: 'Odota hetki listan päivittymistä'})
    })
}
