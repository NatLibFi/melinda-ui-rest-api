...
export function generatef100sf110sf700sf710s() {

  //<xsl:for-each select="set/groups/group[@name='author']/values">
  //
  ...
  // </xsl:template>
  return [{tag: '100', ind1: '1', ind2: ' ', subfields: [{code: 'a', value: 'todo'}]}];
}
